...
Parser::Parser(char *string, ub4 length)
{
    /*  Set parse string.  */
    str = string;
...
bool Parser::parseDecimal(sb4 &val)
{
    ub1 digit;
...
/*  Parses a decimal integer.  */
bool Parser::parseDecimal(sb8 &val)
{
    ub1 digit;
