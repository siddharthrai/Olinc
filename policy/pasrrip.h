...
typedef struct cache_policy_pasrrip_gdata_t
{
  ...
  struct cs_qnode *bt_blocks;                /* Hash table of all CT blocks */ 
  struct cs_qnode *zt_blocks;                /* Hash table of all CT blocks */ 
}pasrrip_gdata;
...
void cache_init_pasrrip(struct cache_params *params, pasrrip_data *policy_data,
