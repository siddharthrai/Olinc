...
#ifndef MEM_SYSTEM_SRRIPT_H
#define	MEM_SYSTEM_SRRIPT_H
...
typedef struct cache_list_head_srript_t
{
  ub4 rrpv;
  struct cache_block_t *head;
}srript_list;

#define SRRIPT_DATA_MAX_RRPV(data)   ((data)->max_rrpv)
#define SRRIPT_DATA_BLOCKS(data)     ((data)->blocks)
#define SRRIPT_DATA_VALID_HEAD(data) ((data)->valid_head)
#define SRRIPT_DATA_VALID_TAIL(data) ((data)->valid_tail)
#define SRRIPT_DATA_FREE_HEAD(data)  ((data)->free_head)
#define SRRIPT_DATA_FREE_TAIL(data)  ((data)->free_tail)
#define SRRIPT_DATA_BT_BLOCKS(data)  ((data)->bt_blocks)
#define SRRIPT_DATA_BT_ACCESS(data)  ((data)->bt_access)

/* RRIP specific data */
typedef struct cache_policy_srript_data_t
{
  ub4            max_rrpv;          /* Maximum RRPV supported */
  srript_list    *valid_head;       /* Head pointers of RRPV specific list */
  srript_list    *valid_tail;       /* Tail pointers of RRPV specific list */
