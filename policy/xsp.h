...
#ifndef MEM_SYSTEM_XSP_H
#define	MEM_SYSTEM_XSP_H
...
typedef struct cache_list_head_xsp_t
{
  ub4 rrpv;
  struct cache_block_t *head;
}xsp_list;

#define XSP_DATA_CFPOLICY(data)   ((data)->current_fill_policy)
#define XSP_DATA_DFPOLICY(data)   ((data)->default_fill_policy)
#define XSP_DATA_CAPOLICY(data)   ((data)->current_access_policy)
#define XSP_DATA_DAPOLICY(data)   ((data)->default_access_policy)
#define XSP_DATA_CRPOLICY(data)   ((data)->current_replacement_policy)
#define XSP_DATA_DRPOLICY(data)   ((data)->default_replacement_policy)
#define XSP_DATA_SET_INDEX(data)  ((data)->set_idx)
#define XSP_DATA_MAX_RRPV(data)   ((data)->max_rrpv)
#define XSP_DATA_WAYS(data)       ((data)->ways)
#define XSP_DATA_BLOCKS(data)     ((data)->blocks)
#define XSP_DATA_VALID_HEAD(data) ((data)->valid_head)
#define XSP_DATA_VALID_TAIL(data) ((data)->valid_tail)
#define XSP_DATA_FREE_HLST(data)  ((data)->free_head)
#define XSP_DATA_FREE_TLST(data)  ((data)->free_tail)
#define XSP_DATA_FREE_HEAD(data)  ((data)->free_head->head)
#define XSP_DATA_FREE_TAIL(data)  ((data)->free_tail->head)

/* RRIP specific data */
typedef struct cache_policy_xsp_data_t
{
...
/* XSP cache wide data */
typedef struct cache_policy_xsp_gdata_t
{
...
void cache_init_xsp(int set, struct cache_params *params, xsp_data *policy_data,
...
void cache_fill_block_xsp(xsp_data *policy_data, 
    xsp_gdata *global_data, int way, long long tag, 
...
void cache_access_block_xsp(xsp_data *policy_data, xsp_gdata *global_data, 
...
int cache_get_new_rrpv_xsp(xsp_data *policy_data, xsp_gdata *global_data,
